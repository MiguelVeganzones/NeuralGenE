...
#include "../Utility/cx_helper_functions.h"
...
public:
    ...
    [[nodiscard]] inline static constexpr size_t position(const board_2D_position pos)
    {
        assert(pos.x >= 0);
        assert(pos.y >= 0);
    ...
    [[nodiscard]] inline static constexpr char pretty_repr(const repr_type value)
    {
    ...
    [[nodiscard]] static board_2D decode(const encode_type& encoded_board2D)
    {
