...
public:
    ...
    public:
            ...
            m_Params(params)
        {
            for (int i = 1; i != N; ++i)
            {
                m_Cummulative_params[i] =
                    m_Params[i] + m_Cummulative_params[i - 1];
            }
        }
        ...
        mutation_policy_type& operator=(mutation_policy_type const&) noexcept =
            default;
        mutation_policy_type& operator=(mutation_policy_type&&) noexcept =
            default;
    ...
    inline static constexpr parameters_type  s_Default_params = { p0, p0, p0,
                                                                  p0, p0, p0 };

public:
    [[nodiscard]]
    static auto generate(parameters_type const& params) noexcept
